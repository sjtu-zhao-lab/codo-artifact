...
#ifndef CODO_TRANSFORMS_EXPLORER_H
#define CODO_TRANSFORMS_EXPLORER_H
...
public:
  explicit LoopDesignSpace(func::FuncOp func, AffineLoopBand &band,
                           codoEstimator &estimator, unsigned maxDspNum,
...
//===----------------------------------------------------------------------===//
// codoExplorer Class Declaration
//===----------------------------------------------------------------------===//

class codoExplorer {
public:
  explicit codoExplorer(codoEstimator &estimator, unsigned outputNum,
  ...
  func::FuncOp applyDesignSpaceExplore(func::FuncOp func, int level);
...
#endif // CODO_TRANSFORMS_EXPLORER_H
