#ifndef CODO_DIALECT_OP_VISITOR_H
#define CODO_DIALECT_OP_VISITOR_H

// #include "codo/InitAll_Dialects_Passes.h"
...
// #include "codo/Dialect/HeteroCLOps.h"
...
public:
  ResultType dispatchVisitor(Operation *op, ExtraArgs... args) {
    ...
    return TypeSwitch<Operation *, ResultType>(op)
        .template Case<
            codo::BufferOp, codo::ConstBufferOp, codo::StreamOp, codo::StreamReadOp, codo::StreamWriteOp,
            // SCF statements.
            ...
            memref::GetGlobalOp, memref::GlobalOp, memref::CopyOp, memref::CollapseShapeOp,
            ...
            math::Log10Op, arith::NegFOp, math::ErfOp,
            ...
            arith::MaxSIOp, arith::MinSIOp, arith::MaxUIOp, arith::MinUIOp, arith::MaximumFOp, arith::MinimumFOp,
            // Logical expressions.
            arith::XOrIOp, arith::AndIOp, arith::OrIOp, arith::ShLIOp,
            arith::ShRSIOp, arith::ShRUIOp, cf::AssertOp,
            // Special operations.
...
#define HANDLE(OPTYPE)                                                         \
  ...
  HANDLE(codo::BufferOp);
  HANDLE(codo::ConstBufferOp);
  HANDLE(codo::StreamOp);
  HANDLE(codo::StreamReadOp);
  HANDLE(codo::StreamWriteOp);
...
#endif // CODO_DIALECT_OP_VISITOR_H