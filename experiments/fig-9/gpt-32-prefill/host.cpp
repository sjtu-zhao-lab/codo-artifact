...
const int DDR[2] = {CHANNEL_NAME(32), CHANNEL_NAME(33)};
  ...
  int main(int argc, char** argv) {
    ...
    //     }
    // }  
      std::vector<ap_uint<256>, aligned_allocator<ap_uint<256>>> source_v834(32*32);
    ...
    std::vector<ap_uint<256>, aligned_allocator<ap_uint<256>>> source_v847(32*32);
...
OCL_CHECK(err, cl::Buffer v834_buf(context, CL_MEM_EXT_PTR_XILINX | CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, sizeof(ap_uint<256>) * 32 *32, &source_v834_hbm, &err));
...
OCL_CHECK(err, cl::Buffer v847_buf(context, CL_MEM_EXT_PTR_XILINX | CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, sizeof(ap_uint<256>) * 32*32, &source_v847_hbm, &err));

// Set kernel arguments
    OCL_CHECK(err, err = kernel.setArg(0, v834_buf));
    OCL_CHECK(err, err = kernel.setArg(1, v834_buf));
