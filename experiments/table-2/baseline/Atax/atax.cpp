...
void main_graph_node0(
 ...
 //  #pragma HLS dataflow
  ...
  for (int v4 = 0; v4 < 390; v4 += 1) {	// L6
    for (int v5 = 0; v5 < 410; v5 += 1) {	// L7
      float v6 = v0[v4][v5];	// L8
      v3[v5][v4] = v6;	// L9
    }
  }
  for (int v7 = 0; v7 < 410; v7 += 1) {	// L12
    v2[v7] = (float)0.000000;	// L13
  }
  for (int v8 = 0; v8 < 410; v8 += 1) {	// L15
    for (int v9 = 0; v9 < 390; v9 += 1) {	// L16
...
void main_graph_node1(
 ...
 //  #pragma HLS dataflow
  ...
  for (int v18 = 0; v18 < 390; v18 += 1) {	// L29
    v17[v18] = (float)0.000000;	// L30
  }
  for (int v19 = 0; v19 < 390; v19 += 1) {	// L32
    for (int v20 = 0; v20 < 410; v20 += 1) {	// L33
...
void main_graph(
 ...
 //  #pragma HLS dataflow
  ...
  main_graph_node1(v26, v27, v29);	// L47
  main_graph_node0(v26, v29, v28);	// L48
}
